        ...
        <Layout>
          <Header className="header-color" scroll>
            ...
            <div className="connect">
              <a
                href="https://github.com/David-Kirsch"
                target="_blank"
                rel="noreferrer"
              >
              ...
              <a
                href="http://linkedin.com/in/davidjkirsch"
                target="_blank"
                rel="noreferrer"
              >
              ...
              <a
                href="https://davidjkirsch.medium.com/"
                target="_blank"
                rel="noreferrer"
              >
                <i class="fab fa-medium"></i>
              </a>
              <a href="mailto:davidjkirsch@gmail.com">
